...
use App\Models\{transaksi,User,harga,DataBank, Notification, order_ck, input_ck};
...

{
    ...
    {
      return view('karyawan.transaksi.welcome');
    }

    public function ck() {
      $ck = order_ck::all();
      return view('karyawan.transaksi.orderck', compact('ck'));
    }
