...
<div class="table-responsive m-t-0">
    ...
    <div class="form-group" size='60%'>
      ...
      <select class="custom-select" name="layanan" id="">
        <option value="Cuci dry clean reguler">Cuci dry clean reguler</option>
        <option value="Cuci dry clean kilat">Cuci dry clean kilat</option>
        <option value="Cuci dry clean express">Cuci dry clean express</option>
      </select>
    </div>
      <div id="myTable_filter" class="dataTables_filter" size="60%">
