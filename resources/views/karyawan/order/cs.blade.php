...
<div class="table-responsive m-t-0">
    ...
    <div id="myTable_filter" class="dataTables_filter" size="60%">
        <label for="nama">Nama customer</label>
            <input type="text" name="nama" class="form-control" size="50%" aria-controls="myTable">
    </div>
    <br>
    <div class="form-group" size='60%'>
      <label for="">Pilih layanan Paket</label>
      <select class="custom-select" name="pakaian" id="">
        <option value="Jaket kulit">Jaket kulit</option>
        <option value="Jaket non kulit">Jaket non kulit</option>
        <option value="Boneka mini">Boneka mini</option>
        <option value="Boneka sedang">Boneka sedang</option>
