            ...
            <div class="navbar-container content">
                <div class="navbar-collapse" id="navbar-mobile">
                    <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                        ...
                        <span class="user-name text-bold-600">Selamat datang, {{auth::user()->name}}</span>
                        ...
                        <li class="dropdown dropdown-user nav-item">
                          ...
                          <div class="dropdown-menu dropdown-menu-right">
                            ...
                            @elseif(auth::user()->auth == 'Customer')
                              <a class="dropdown-item" href=" {{url('me', auth::user()->id)}} "><i class="feather icon-user"></i>Profile
                              </a>
                            @endif
                ...
                {{-- Menu Admin --}}
                    @if (auth::user()->auth == "Admin")
                        ...
                        <li class="nav-item {{ (request()->is('transaksi')) ? 'active' : '' }}">
                          <a href="{{route('transaksi.index')}}"><i class="feather icon-shopping-cart"></i><span class="menu-item" data-i18n="List">Transaksi customer</span></a>
                        </li>
                        <li class="nav-item"><a href="{{url('riwayat-customer')}}"><i class="feather icon-file-text"></i><span class="menu-title" data-i18n="Dashboard">Riwayat customer</span></a>

                        <li class=" nav-item"><a href=""><i class="feather icon-dollar-sign"></i><span class="menu-title" data-i18n="User">Daftar Harga</span></a>
                          <ul class="menu-content">
                              <li class="nav-item">
                                <a href="{{url('admin/harga/cuci-komplit')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Cuci Kiloan</span></a>
                              </li>
                              <li class="nav-item">
                                <a href="{{url('admin/harga/cuci-dry-clean')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Cuci dry clean</span></a>
                              </li>
                              <li class="nav-item">
                                <a href="{{url('admin/harga/cuci-satuan')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Cuci Satuan</span></a>
                              </li>
                          </ul>
                      </li>
                      <li class="nav-item"><a href="{{url('/')}}" target="_blank"><i class="feather icon-square"></i><span class="menu-title" data-i18n="Dashboard">Home</span></a>
                      ...
                      <li class=" nav-item"><a href="#"><i class="feather icon-layers"></i><span class="menu-title" data-i18n="User">Data Transaksi</span></a>
                          <ul class="menu-content">
                              <!-- <li class="nav-item {{ (request()->is('pelayanan')) ? 'active' : '' }}">
                                <a href="{{url('/order')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Buat pesanan</span></a>
                              </li> -->
                              <li class="nav-item {{ (request()->is('customers')) ? 'active' : '' }}">
                                <a href="{{url('customers')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Tambah orderan</span></a>
                              </li>
                          </ul>
                      </li>
                      <li class=" nav-item"><a href=""><i class="feather icon-dollar-sign"></i><span class="menu-title" data-i18n="User">Daftar Harga</span></a>
                          <ul class="menu-content">
                              <li class="nav-item">
                                <a href="{{url('harga/cuci-komplit')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Cuci Kiloan</span></a>
                              </li>
                              <li class="nav-item">
                                <a href="{{url('harga/cuci-dry-clean')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Cuci dry clean</span></a>
                              </li>
                              <li class="nav-item">
                                <a href="{{url('harga/cuci-satuan')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Cuci Satuan</span></a>
                              </li>
                          </ul>
                      </li>
                      <li class="nav-item"><a href="{{url('/laporan')}}"><i class="feather icon-file-text"></i><span class="menu-title" data-i18n="Dashboard">Riwayat transaksi</span></a>
                    ...
                    @elseif(Auth::user()->auth == 'Customer')
                      ...
                      <li class=" nav-item"><a href="#"><i class="feather icon-layers"></i><span class="menu-title" data-i18n="User">Riwayat transaksi</span></a>
                          <ul class="menu-content">
                              <li class="nav-item">
                                <a href="{{url('riwayat/cuci-komplit')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Cuci Kiloan</span></a>
                              </li>
                              <li class="nav-item">
                                <a href="{{url('riwayat/cuci-dry-clean')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Cuci dry clean</span></a>
                              </li>
                              <li class="nav-item">
                                <a href="{{url('riwayat/cuci-satuan')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Cuci satuan</span></a>
                              </li>
                          </ul>
                      </li>
                      <li class="nav-item"><a href="{{url('/')}}" target="_blank"><i class="feather icon-square"></i><span class="menu-title" data-i18n="Dashboard">Home</span></a>
