...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card">
        ...
        <hr>
        <form action="/hargack/update/{{ $ck->id }}" method="post">
          @csrf
              ...
              <div class="card-body">
                <div class="card-text">
                    <dl class="row">
                        ...
                        <dd class="col-sm-4">
                          <div class="input-group">
                              <input type="text" class="form-control" name="paket_layanan" id="" aria-describedby="helpId" value="{{$ck->paket_layanan}}" autocomplete="off">
                            </div>
                          </div>
                        </dd>
                    </dl>
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-4">
                          <div class="input-group">
                          <input type="text" class="form-control" name="durasi_kerja" id="" aria-describedby="helpId" value="{{$ck->durasi_kerja}}" autocomplete="off">
                          </div></dd>
                    </dl>
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-4">
                            <div class="input-group">
                            <input type="number" class="form-control" name="harga_perkg" id="" aria-describedby="helpId" value="{{$ck->harga_perkg}}" autocomplete="off">
                            </div>
                        </dd>
                    </dl>
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-4">
                        <div class="input-group">
                        <input type="number" class="form-control" min="0" name="qty_perkg" id="" aria-describedby="helpId" value="{{$ck->qty_perkg}}" autocomplete="off">
                          </div>
                        </dd>
                    </dl>
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-4">
                        <div class="input-group">
                        <input type="number" readonly class="form-control" name="total_harga" id="" aria-describedby="helpId" value="{{$ck->total_harga}}" autocomplete="off">
                          </div>
                        </dd>
                    </dl>
