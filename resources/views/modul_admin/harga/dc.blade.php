  ...
  <div class="col-sm-12 col-md-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Data harga laundry dry clean</h4>
        </div>
        <hr>
        <form action="/hargadc/update/{{ $dc->id }}" method="post">
          @csrf
              ...
              <div class="card-body">
                <div class="card-text">
                    <dl class="row">
                        ...
                        <dd class="col-sm-4">
                          <div class="input-group">
                              <input type="text" class="form-control" name="paket_layanan" id="" aria-describedby="helpId" value="{{$dc->paket_layanan}}" autocomplete="off">
                            </div>
                          </div>
                        </dd>
                    </dl>
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-4">
                          <div class="input-group">
                          <input type="text" class="form-control" name="durasi_kerja" id="" aria-describedby="helpId" value="{{$dc->durasi_kerja}}" autocomplete="off">
                          </div></dd>
                    </dl>
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-4">
                            <div class="input-group">
                            <input type="number" class="form-control" name="harga_perkg" id="" aria-describedby="helpId" value="{{$dc->harga_perkg}}" autocomplete="off">
                            </div>
                        </dd>
                    </dl>
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-4">
                        <div class="input-group">
                        <input type="number" class="form-control" name="qty_perkg" min="0" aria-describedby="helpId" value="{{$dc->qty_perkg}}" autocomplete="off">
                          </div>
                        </dd>
                    </dl>
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-4">
                        <div class="input-group">
                        <input type="number" readonly class="form-control" name="total_harga" id="" aria-describedby="helpId" value="{{$dc->total_harga}}" autocomplete="off">
                          </div>
                        </dd>
                    </dl>
