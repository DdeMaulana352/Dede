  ...
  <div class="col-sm-12 col-md-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Tambah harga order cuci dry clean</h4>
        </div>
        <hr>
        <form action="/hargadc/store/" method="post">
          @csrf
              ...
              <div class="card-body">
                <div class="card-text">
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-4">
                            <div class="input-group">
                            <input type="number" min="0" class="form-control" name="harga_perkg" id="" aria-describedby="helpId" autocomplete="off">
                            </div>
                        </dd>
                    </dl>
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-4">
                        <div class="input-group">
                        <input type="number" class="form-control" name="qty_perkg" id="" min="0" aria-describedby="helpId" autocomplete="off">
                          </div>
                        </dd>
                    </dl>
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-4">
                        <div class="input-group">
                        <input type="number" class="form-control" name="total_harga" id="" aria-describedby="helpId" autocomplete="off" readonly>
                          </div>
                        </dd>
                    </dl>
...
function updateTotalHarga() {
    ...
    totalHargaInput.value = totalHarga; // Menyertakan dua desimal di belakang koma (opsional)
}
  </script>
