                        ...
                        <tr>
                            ...
                            <td>
                              <form action="{{ route('karyawan.destroy',$item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <a class="btn btn-sm btn-{{$item->status == 'Active' ? 'success' : 'danger'}}" data-id-update="{{$item->id}}" id="updateStatus" style="color:white;">{{$item->status == 'Active' ? 'Non-Aktifkan' : 'Aktifkan'}}</a>
                              </form>
                              <a href="/karyawan/edit/{{ $item->id }}" class="btn btn-info btn-sm">Edit karyawan</a>
                            </td>
                        </tr>
                        <?php $no++; ?>
                        @endforeach
